...
#ifndef __MB_CAPSULE_PRIMITIVE__
#define __MB_CAPSULE_PRIMITIVE__
...
namespace mb
{
  ...
  protected:
    void calcNewRing( float radius, float height, unsigned int segments,
      float r, float y, float dy );

  };
}

#endif /* __MB_CAPSULE_PRIMITIVE__ */
